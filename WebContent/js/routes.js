...
var map;
  function initialize(){
	...
	/****/
	    ...
	    var onMarkerMouseOver = function() {
	      var latLng = this.getPosition();
	      infoWindow2.setContent('<h3>Salamca</h3><img src="images/sala.png" /><br>latitude=' +
	   ...
	   var mkr = new google.maps.Marker({
	    ...
	    var onMarkerMouseOver = function() {
	      var latLng = this.getPosition();
	      infoWindow2.setContent('<h3>Chihuahua</h3><img src="images/sala.png" /><br>latitude=' +
	          latLng.lat() + ', longitude=' + latLng.lng()+'<br><br><a href="https://es.wikipedia.org/wiki/Chihuahua_(Chihuahua)">link to site</a>');
	      infoWindow2.open(map, this);
	    };
	    google.maps.event.addListener(map, 'mouseout', function() {
	      infoWindow2.close();
	   ...
	   var mkr = new google.maps.Marker({
				...
				position:{lat: 31.083332, lng:-108.000000},
				map: map,
				title: 'Chihuahua'
